...
const navItems = [
  ...
  { path: '/admin/case-study-wizard', label: 'Case Study Wizard', icon: Wand2 },
];
...
export function AdminLayout() {
  ...
  const sidebarContent = (
    <>
      <div className="mb-6">
        <h3 className="text-sm uppercase tracking-wider text-zinc-500 mb-2">Admin Portal</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-medium">{currentPage?.label || 'Admin'}</span>
            </div>
            {mobileNavOpen ? (
