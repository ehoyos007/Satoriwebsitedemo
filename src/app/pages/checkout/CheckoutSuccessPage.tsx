...
import { CheckCircle, ArrowRight, User, LayoutDashboard } from 'lucide-react';
        ...
        >
          ...
          <ol className="space-y-3 text-zinc-400">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>{user ? 'Head to your portal to start onboarding' : 'Create your account to access your client portal'}</span>
            </li>
            <li className="flex items-start gap-3">
